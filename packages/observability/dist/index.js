...
export async function initTelemetry(opts) {
    if (telemetrySdk)
        return { enabled: telemetryEnabled, shutdown: shutdownTelemetry };
    ...
    if (!telemetryEnabled || tracesExporter.toLowerCase() === "none")
        return { enabled: false, shutdown: shutdownTelemetry };
